...
iLink 是一套 **CLI-native 的 AI 多角色软件开发协作系统**，可运行在 macOS、Windows、Linux 等主流操作系统上。它利用成熟的 Host CLI 工具（Claude CLI / Qoder CLI / Codex CLI）的原生 LLM 能力，以**文件状态机**驱动两条工作线：
...
本项目使用 iLink 多角色 AI 协作流水线（Root Spec v1.3.00）。
