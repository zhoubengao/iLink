...
| **直接编辑** | 明显误报，或人类直接知道结论 | 手动修改 STAGING 文档：删除/更新阻塞项、调整 C1、改 Status |
...
6. **更新 Status**：所有 H 级阻塞项消解后，AI 将 Status 更新为对应 PENDING_xxx；否则维持 STAGING
7. **提示下一步**：若 Status 已更新为 PENDING_xxx，提示人类执行 `ilink-approve` 正式推进
