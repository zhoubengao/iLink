...
**情况 B：CLAUDE.md 已是 iLink 引导且引用 Root Spec v1.1.00**
→ 跳过，无需修改。

**情况 C：CLAUDE.md 已是 iLink 引导但引用旧版本**（如 v1.5、SRS）
→ 更新版本引用为 Root Spec v1.1.00。
...
本项目使用 iLink 多角色 AI 协作流水线（Root Spec v1.1.00）。
...
**情况 B：AGENTS.md 已是 iLink 引导且引用 Root Spec v1.1.00**
→ 跳过，无需修改。

**情况 C：AGENTS.md 已是 iLink 引导但引用旧版本**（如 v1.5、SRS）
→ 更新版本引用为 Root Spec v1.1.00，保留其他自定义内容。
