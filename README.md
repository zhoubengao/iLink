...
- **Domain Knowledge（领域知识）**：认知模式下 AI 读取既有源码，生成 10 章标准领域知识文档——业务实体、流程全景、设计决策、实现品评，由资深工程师引导，沉淀为团队认知资产，对标国际知名开源产品水准
...
| 角色 | 职责 | 输入 | 输出 |
|------|------|------|------|
| **Domain Engineer** | 读取既有源码，提炼业务实体、流程全景、设计决策，生成领域知识文档；实现品评对标国际知名开源产品 | 既有源码 | domain-knowledge.md |
